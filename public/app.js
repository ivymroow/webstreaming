...
function W(){return'<div class="welcome"><div class="welcome-card"><h1 style="color:var(--primary)">web-streaming <span class="beta-tag">beta</span></h1><p>a simple streaming site that simply works.</p><ul class="welcome-list"><li>simply doesn\'t spam ads</li><li>simply doesn\'t break half the time</li><li>simply just works</li></ul><p>everything runs with no budget. hosted on render\'s free tier.</p><p style="font-size:13px;color:#f59e0b;font-weight:600">it is recommended to disable adblockers while using this site. the embeds load way faster without. some embed providers glitch some episodes / shows so just choose another one and move on. this was hard to make. it was all free no budget.</p><p style="font-size:13px;margin-top:8px"><a href="#" onclick="navigate(\'notice\');return false" style="color:var(--primary)">view full project build</a></p><button class="btn btn-primary" style="margin-top:20px;font-size:16px;padding:14px 48px" onclick="navigate(\'home\')">enter</button></div></div>'}

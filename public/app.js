...
function NT(){document.title='notice - webstreaming';return'<div style="max-width:800px;margin:0 auto;padding:32px"><button class="detail-back" onclick="navigate(\'home\')"><svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2"><path d="m15 18-6-6 6-6"/></svg>back</button><h1 style="font-size:28px;font-weight:800;margin:20px 0 8px;color:var(--primary)">project notice</h1><p style="color:var(--text-muted);margin-bottom:32px;line-height:1.6">how webstreaming works. no magic, just free apis.</p><div class="ns"><h2>architecture</h2><pre style="background:var(--surface);padding:16px;border-radius:var(--radius);color:var(--primary);font-size:13px;line-height:1.8;overflow-x:auto">browser\n  -> render (express.js)\n    -> embed apis (2embed, multiembed, smashy)\n      -> iframe / new tab\n  -> imdb api (search)\n  -> wikipedia api (details)\n  -> tvmaze api (episodes)\n  -> supabase (accounts)</pre></div><div class="ns"><h2>flow</h2><ol style="color:var(--primary);line-height:2;padding-left:20px"><li>search via imdb suggestion api</li><li>details from wikipedia rest api</li><li>episodes from tvmaze api</li><li>sources from embed providers</li><li>play opens in new tab, zero p2p</li></ol></div><div class="ns"><h2>apis used</h2><table style="width:100%;border-collapse:collapse;font-size:13px"><tr style="border-bottom:1px solid var(--border)"><td style="padding:8px;color:var(--text)">imdb</td><td style="padding:8px;color:var(--text-muted)">search + metadata</td><td style="padding:8px;color:#4ade80;font-size:12px">free</td></tr><tr style="border-bottom:1px solid var(--border)"><td style="padding:8px;color:var(--text)">wikipedia</td><td style="padding:8px;color:var(--text-muted)">plot summaries</td><td style="padding:8px;color:#4ade80;font-size:12px">free</td></tr><tr style="border-bottom:1px solid var(--border)"><td style="padding:8px;color:var(--text)">tvmaze</td><td style="padding:8px;color:var(--text-muted)">episode guides</td><td style="padding:8px;color:#4ade80;font-size:12px">free</td></tr><tr style="border-bottom:1px solid var(--border)"><td style="padding:8px;color:var(--text)">vidsrc.to</td><td style="padding:8px;color:var(--text-muted)">best player</td><td style="padding:8px;color:#4ade80;font-size:12px">free</td></tr><tr style="border-bottom:1px solid var(--border)"><td style="padding:8px;color:var(--text)">2embed</td><td style="padding:8px;color:var(--text-muted)">reliable</td><td style="padding:8px;color:#4ade80;font-size:12px">free</td></tr><tr style="border-bottom:1px solid var(--border)"><td style="padding:8px;color:var(--text)">vidsrc.me</td><td style="padding:8px;color:var(--text-muted)">alt player</td><td style="padding:8px;color:#4ade80;font-size:12px">free</td></tr><tr style="border-bottom:1px solid var(--border)"><td style="padding:8px;color:var(--text)">vidlink</td><td style="padding:8px;color:var(--text-muted)">alt player</td><td style="padding:8px;color:#4ade80;font-size:12px">free</td></tr><tr style="border-bottom:1px solid var(--border)"><td style="padding:8px;color:var(--text)">multiembed</td><td style="padding:8px;color:var(--text-muted)">aggregator</td><td style="padding:8px;color:#4ade80;font-size:12px">free</td></tr><tr style="border-bottom:1px solid var(--border)"><td style="padding:8px;color:var(--text)">smashy</td><td style="padding:8px;color:var(--text-muted)">fast server</td><td style="padding:8px;color:#4ade80;font-size:12px">free</td></tr><tr style="border-bottom:1px solid var(--border)"><td style="padding:8px;color:var(--text)">supabase</td><td style="padding:8px;color:var(--text-muted)">accounts</td><td style="padding:8px;color:#4ade80;font-size:12px">free</td></tr></table></div><div class="ns"><h2>deployment</h2><p style="color:var(--text-secondary);line-height:1.8;font-size:13px">render free tier, docker container, node 22. built-in self-ping keepalive every 5 minutes.</p></div><div class="ns"><h2>source</h2><p style="color:var(--text-muted);font-size:13px"><a href="https://github.com/ivymroow/webstreaming" target="_blank" style="color:var(--primary)">github.com/ivymroow/webstreaming</a></p></div><div class="ns"><h2>sites</h2><p style="color:var(--text);font-size:13px;line-height:1.8"><a href="https://webtesting.up.railway.app" target="_blank" style="color:var(--primary)">webtesting.up.railway.app</a><span style="color:var(--text-muted)"> — main site. fast and fast with updates</span></p><p style="color:var(--text);font-size:13px;line-height:1.8"><a href="https://webstreaming.onrender.com" target="_blank" style="color:var(--primary)">webstreaming.onrender.com</a><span style="color:var(--text-muted)"> — sleeps on free tier, slow with updates, not main anymore</span></p></div><div class="ns"><h2>disclaimer</h2><p style="color:var(--text-muted);font-size:13px;line-height:1.7">personal use only. the developer is not responsible for how this software is used.</p><p style="color:var(--text-muted);font-size:12px;margin-top:8px">built solo with no budget.</p><p style="color:var(--text-muted);font-size:10px;margin-top:4px">1.0.3</p></div></div>'}

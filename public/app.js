...
function RD(d,srces,episodes){
  ...
  if(isTv){
    ...
    epHTML='<div class="episode-picker"><div class="sources-title">Select Episode</div><div class="episode-controls"><select id="seasonSelect">'+episodes.map(s=>'<option value="'+s.season+'">'+(s.season===0?'Specials / holiday episodes':'Season '+s.season)+' ('+s.episodes.length+' eps)</option>').join('')+'</select><select id="episodeSelect"></select></div><div id="episodeInfo" class="episode-info"></div><div class="sources-section" style="margin-top:12px"><div class="sources-title">Sources</div><div class="sources-list" id="sl"><div class="loading-screen" style="padding:12px"><div class="spinner"></div></div></div></div></div>'
  }

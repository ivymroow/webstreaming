...
function W(){return'<div class="welcome"><div class="welcome-card"><h1 style="color:var(--primary)">webstreaming <span class="beta-tag">beta</span></h1><p>a simple streaming site that simply works.</p><ul class="welcome-list"><li>simply doesn\'t spam ads</li><li>simply doesn\'t break half the time</li><li>simply just works</li></ul><p>everything runs with no budget. hosted on railway\'s free tier & render\'s free tier.</p><p style="font-size:13px;color:#f59e0b;font-weight:600">it is recommended to disable adblockers while using this site. the embeds load way faster without. some embed providers glitch some episodes / shows so just choose another one and move on. this was hard to make. it was all free no budget.</p><p style="font-size:13px;margin-top:8px"><a href="#" onclick="navigate(\'notice\');return false" style="color:var(--primary)">view full project build</a></p><p style="color:var(--text-muted);font-size:10px;margin-top:2px">1.0.1</p><button class="btn btn-primary" style="margin-top:20px;font-size:16px;padding:14px 48px" onclick="navigate(\'home\')">enter</button></div></div>'}
...
function G(id,items){
  ...
  el.innerHTML=items.map(i=>{const p=img(i.poster),t=title(i),y=year(i),r=rating(i),tp=i.type;(i.progress||0)>0
    return'<div class="card" data-id="'+i.id+'" data-title="'+esc(title(i))+'" data-poster="'+(i.poster||'')+'" onclick="navigate(\'detail\',{id:\''+i.id+'\',type:\''+(tp||'movie')+'\',title:\''+esc(title(i))+'\',year:\''+(year(i)||'')+'\',poster:\''+(i.poster||'')+'\'})"><img class="card-poster" src="'+p+'" alt="'+esc(t)+'" loading="lazy" referrerpolicy="no-referrer" onerror="this.src=\'data:image/svg+xml,<svg xmlns=%22http://www.w3.org/2000/svg%22 viewBox=%220 0 200 300%22><rect fill=%22%231a1a1a%22 width=%22200%22 height=%22300%22/><text x=%22100%22 y=%22160%22 text-anchor=%22middle%22 font-size=%2248%22 fill=%22%23555%22>🎬</text></svg>\'"><span class="card-badge">'+(tp==='tv'?'TV':'Movie')+'</span>'+(r?'<span class="card-rating"><svg viewBox="0 0 24 24" width="10" height="10" fill="currentColor"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg>'+r+'</span>':'')+(i.progress?'<div class="progress-bar"><div class="progress-fill" style="width:'+Math.min(i.progress*100,100)+'%"></div></div>':'')+'<div class="card-info"><div class="card-title">'+esc(t)+'</div><div class="card-meta">'+(y||'')+'</div></div></div>'}).join('')
}

function NT(){document.title='notice - webstreaming';return'<div style="max-width:800px;margin:0 auto;padding:32px"><button class="detail-back" onclick="navigate(\'home\')"><svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2"><path d="m15 18-6-6 6-6"/></svg>back</button><h1 style="font-size:28px;font-weight:800;margin:20px 0 8px;color:var(--primary)">project notice</h1><p style="color:var(--text-muted);margin-bottom:32px;line-height:1.6">how webstreaming works. no magic, just free apis.</p><div class="ns"><h2>architecture</h2><pre style="background:var(--surface);padding:16px;border-radius:var(--radius);color:var(--primary);font-size:13px;line-height:1.8;overflow-x:auto">browser\n  -> render (express.js)\n    -> embed apis (2embed, multiembed, smashy)\n      -> iframe / new tab\n  -> imdb api (search)\n  -> wikipedia api (details)\n  -> tvmaze api (episodes)\n  -> supabase (accounts)</pre></div><div class="ns"><h2>flow</h2><ol style="color:var(--primary);line-height:2;padding-left:20px"><li>search via imdb suggestion api</li><li>details from wikipedia rest api</li><li>episodes from tvmaze api</li><li>sources from embed providers</li><li>play opens in new tab, zero p2p</li></ol></div><div class="ns"><h2>apis used</h2><table style="width:100%;border-collapse:collapse;font-size:13px"><tr style="border-bottom:1px solid var(--border)"><td style="padding:8px;color:var(--primary)">imdb</td><td style="padding:8px;color:var(--primary)">search + metadata</td><td style="padding:8px;color:var(--primary);font-size:12px">free</td></tr><tr style="border-bottom:1px solid var(--border)"><td style="padding:8px;color:var(--primary)">wikipedia</td><td style="padding:8px;color:var(--primary)">plot summaries</td><td style="padding:8px;color:var(--primary);font-size:12px">free</td></tr><tr style="border-bottom:1px solid var(--border)"><td style="padding:8px;color:var(--primary)">tvmaze</td><td style="padding:8px;color:var(--primary)">episode guides</td><td style="padding:8px;color:var(--primary);font-size:12px">free</td></tr><tr style="border-bottom:1px solid var(--border)"><td style="padding:8px;color:var(--primary)">vidsrc.to</td><td style="padding:8px;color:var(--primary)">best player</td><td style="padding:8px;color:var(--primary);font-size:12px">free</td></tr><tr style="border-bottom:1px solid var(--border)"><td style="padding:8px;color:var(--primary)">2embed</td><td style="padding:8px;color:var(--primary)">reliable</td><td style="padding:8px;color:var(--primary);font-size:12px">free</td></tr><tr style="border-bottom:1px solid var(--border)"><td style="padding:8px;color:var(--primary)">vidsrc.me</td><td style="padding:8px;color:var(--primary)">alt player</td><td style="padding:8px;color:var(--primary);font-size:12px">free</td></tr><tr style="border-bottom:1px solid var(--border)"><td style="padding:8px;color:var(--primary)">vidlink</td><td style="padding:8px;color:var(--primary)">alt player</td><td style="padding:8px;color:var(--primary);font-size:12px">free</td></tr><tr style="border-bottom:1px solid var(--border)"><td style="padding:8px;color:var(--primary)">multiembed</td><td style="padding:8px;color:var(--primary)">aggregator</td><td style="padding:8px;color:var(--primary);font-size:12px">free</td></tr><tr style="border-bottom:1px solid var(--border)"><td style="padding:8px;color:var(--primary)">smashy</td><td style="padding:8px;color:var(--primary)">fast server</td><td style="padding:8px;color:var(--primary);font-size:12px">free</td></tr><tr style="border-bottom:1px solid var(--border)"><td style="padding:8px;color:var(--primary)">supabase</td><td style="padding:8px;color:var(--primary)">accounts</td><td style="padding:8px;color:var(--primary);font-size:12px">free</td></tr></table></div><div class="ns"><h2>deployment</h2><p style="color:var(--primary);line-height:1.8;font-size:13px">render free tier, docker container, node 22. built-in self-ping keepalive every 5 minutes.</p></div><div class="ns"><h2>source</h2><p style="color:var(--text-muted);font-size:13px"><a href="https://github.com/ivymroow/webstreaming" target="_blank" style="color:var(--primary)">github.com/ivymroow/webstreaming</a></p></div><div class="ns"><h2>sites</h2><p style="color:var(--text);font-size:13px;line-height:1.8"><a href="https://webtesting.up.railway.app" target="_blank" style="color:var(--primary)">webtesting.up.railway.app</a><span style="color:var(--text-muted)"> — main site. fast and fast with updates</span></p><p style="color:var(--text);font-size:13px;line-height:1.8"><a href="https://webstreaming.onrender.com" target="_blank" style="color:var(--primary)">webstreaming.onrender.com</a><span style="color:var(--text-muted)"> — sleeps on free tier, slow with updates, not main anymore</span></p></div><div class="ns"><h2>disclaimer</h2><p style="color:var(--text-muted);font-size:13px;line-height:1.7">personal use only. the developer is not responsible for how this software is used.</p><p style="color:var(--text-muted);font-size:12px;margin-top:8px">built solo with no budget.</p><p style="color:var(--text-muted);font-size:10px;margin-top:4px">1.0.1</p></div></div>'}
